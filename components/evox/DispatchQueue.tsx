        ...
        <div className="border-b border-[#222222] bg-[#0a0a0a] px-3 py-2">
          ...
          <div className="mt-2 flex gap-2">
            <input
              ...
              className="flex-1 rounded border border-[#333333] bg-[#1a1a1a] px-2 py-1 text-xs text-white placeholder-[#555555] focus:border-[#555555] focus:outline-none"
            />
            <button
              type="button"
...
function SortableDispatchItem({ dispatch }: { dispatch: Dispatch }) {
  ...
  return (
    <div
      ...
      style={style}
      className={cn(
        "flex items-center gap-2 border-b border-[#222222] px-3 py-2 text-xs transition-colors",
        isDragging && "bg-[#1a1a1a] opacity-80 shadow-lg",
